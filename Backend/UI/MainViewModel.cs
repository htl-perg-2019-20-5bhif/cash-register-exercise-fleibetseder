...
namespace UI
{
    public class MainViewModel : BindableBase
    {
        ...
        public decimal TotalSum => Basket.Sum(art => art.TotalPrice);
        ...
        {
            //initial Befüllung mit Produkten
        ...
        {
            //Produkt in Warenkorb hinzufügen (egal ob neues Produkt oder wiederholtes
